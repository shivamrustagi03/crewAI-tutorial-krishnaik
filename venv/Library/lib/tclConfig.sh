...
# installed.
TCL_PREFIX='D:/CrewAI Course/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/CrewAI Course/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/CrewAI Course/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/CrewAI Course/venv\Library\include'
...
TCL_PACKAGE_PATH='D:/CrewAI Course/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/CrewAI Course/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/CrewAI Course/venv\Library\lib\tclstub86.lib'
